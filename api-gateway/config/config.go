...
type Config struct {
	...
	// RecommendServicePort int
	// PaymendServiceHost   string
	// PaymendServicePort   int
...
func Load() Config {
	...
	// c.RecommendServiceHost = cast.ToString(getOrReturnDefault("COMMENT_SERVICE_HOST", "localhost"))
	// c.RecommendServicePort = cast.ToInt(getOrReturnDefault("COMMENT_SERVICE_PORT", 3333))

	// // payment service bn connect
	// c.PaymendServiceHost = cast.ToString(getOrReturnDefault("PAYMENT_SERVICE_HOST", "localhost"))
    // c.PaymendServicePort = cast.ToInt(getOrReturnDefault("PAYMENT_SERVICE_PORT", 4444))
